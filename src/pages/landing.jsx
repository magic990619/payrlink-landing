...
const landing = () => {
  const news = "🚀Public sale starts on June 4th 00:00AM (UTC +0). Please visit the public sale page and buy PAYR with 10% discount than the listing price. Join our community and stay tuned! - PayrLink Core Team -"
  return (
